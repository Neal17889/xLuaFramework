		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.GetComponentAtIndex( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _instanceID = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.SceneManagement.Scene gen_ret = UnityEngine.GameObject.GetScene( _instanceID );
                        translator.Push(L, gen_ret);
